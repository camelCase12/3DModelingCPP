...
public:
	...
	static double angleBetweenVectors(Vector2D v1, Vector2D v2); // Returns the angular difference between two vectors in 2D space

	static Vector3D relativize(Vector3D zero, Vector3D relative); // Returns the difference of one vector relative to another

	static Vector2D relativize(Vector2D zero, Vector2D relative); // Returns the difference of one vector relative to another
	...
	static Vector2D projectVector(Vector2D a, Vector2D b); // Overload of 3d vect proj for 2d
